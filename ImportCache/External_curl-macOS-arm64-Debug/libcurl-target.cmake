...
set_target_properties(CURL::libcurl_static PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "-framework SystemConfiguration;-framework CoreFoundation;-framework CoreServices;\$<LINK_ONLY:OpenSSL::SSL>;\$<LINK_ONLY:OpenSSL::Crypto>;\$<LINK_ONLY:stdc++>;\$<LINK_ONLY:ZLIB::ZLIB>;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/lib/libSystem.B.tbd"
)
...
set_target_properties(CURL::libcurl_static PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "lib/libcurl-d.a"
  )
