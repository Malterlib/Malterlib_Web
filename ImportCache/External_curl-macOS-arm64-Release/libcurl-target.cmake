...
set_target_properties(CURL::libcurl_static PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "-framework SystemConfiguration;-framework CoreFoundation;-framework CoreServices;\$<LINK_ONLY:OpenSSL::SSL>;\$<LINK_ONLY:OpenSSL::Crypto>;\$<LINK_ONLY:stdc++>;\$<LINK_ONLY:ZLIB::ZLIB>;\$<LINK_ONLY:CURL::zstd>;\$<LINK_ONLY:Threads::Threads>;\$<LINK_ONLY:Threads::Threads>"
)
