...
namespace NMib::NWeb
{
	...
	public:
		...
		struct CConnectSettings
		{
			...
			bool m_bNegotiateUnmaskedFrames = false;	// Ask the server for unmasked frames in the handshake. A server that does not agree leaves masking on, so deployments stay safe
