...
namespace NMib
{
	...
	namespace NHTTP
	{
		...
		CResponseStage::CResponseStage(NPtr::TCUniquePointer<CResponseDetails> _pD)
			: mp_pD(fg_Move(_pD))
		{
		}
		...
		CResponseContent::CResponseContent(NPtr::TCUniquePointer<CResponseDetails> _pD)
		...
		CResponseTrailer::CResponseTrailer(NPtr::TCUniquePointer<CResponseDetails> _pD)
			: CResponseStage(fg_Move(_pD))
		{
