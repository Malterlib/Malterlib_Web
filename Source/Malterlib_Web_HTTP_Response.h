...
namespace NMib
{
	...
	namespace NHTTP
	{
		...
		protected:
			NPtr::TCUniquePointer<CResponseDetails> mp_pD;

		public:
			CResponseStage(NPtr::TCUniquePointer<CResponseDetails> _pD);
		...
		public:
			...
			CResponseTrailer(NPtr::TCUniquePointer<CResponseDetails> _pD);
			~CResponseTrailer();
		...
		public:
			...
			CResponseContent(NPtr::TCUniquePointer<CResponseDetails> _pD);
			~CResponseContent();
